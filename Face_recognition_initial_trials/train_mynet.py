...
model.save('my_net_LeRelu_globavgpool_35.h5')
...
np.save("mynet_Acc_LeRelu_globavgpool_35.npy", history.history['acc'])
np.save("mynet_val.Acc_LeRelu_globavgpool_35.npy", history.history['val_acc'])
np.save("mynet_Loss_LeRelu_globavgpool_35.npy", history.history['loss'])
np.save("mynet_val.Loss_LeRelu_globavgpool_35.npy", history.history['val_loss'])
